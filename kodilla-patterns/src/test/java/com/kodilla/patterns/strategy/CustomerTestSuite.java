...
public class CustomerTestSuite {
    //sprawdzający, czy strategie inwestycyjne są poprawnie przypisane do różnych klas użytkowników (domyślne strategie)
    @Test
    ...
    //sprawdza, czy po zmianie strategii inwestowania dla jednego z klientów nowa strategia jest poprawnie przypisana
    @Test
